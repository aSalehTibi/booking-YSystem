...
<fieldset id="customReportInput-container">
    <form id="customReportInput" action="../abrechnung2.php" method="post">
        <div id="custom-report-input">
            ...
            <div class="input-set">
                <label for="range_within" style="width:auto;">Format</label>
                <input type="radio" name="format" value="1" checked="checked"/> Details (für Profs.)<br/>
                <input type="radio" name="format" value="2"/> Summiert nach Ressource
            </div>
