 ...
 */
$conf['settings']['app.title'] = 'HHU CAi Buchungskalender';			// application title
$conf['settings']['default.timezone'] = 'Europe/Berlin';      // look up here http://php.net/manual/en/timezones.php
$conf['settings']['allow.self.registration'] = 'true';         	// if users can register themselves
$conf['settings']['admin.email'] = 'cai@hhu.de';         // email address of admin user
$conf['settings']['admin.email.name'] = 'HHU CAi Administrator';	// name to be used in From: field when sending automatic emails
...
$conf['settings']['script.url'] = 'http://134.99.190.95/latest';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['privacy']['hide.user.details'] = 'true';    			// if personal user details should be displayed to non-administrators
$conf['settings']['privacy']['hide.reservation.details'] = 'true';			// if reservation details should be displayed to non-administrators
...
$conf['settings']['phpmailer']['smtp.host'] = 'mail.rz.uni-duesseldorf.de';               // 'smtp.company.com'
